...
# ⚠️ 必须和 local-llm/start_server.sh 里的 --model 参数完全一致(字符串严格比对)
# mlx-vlm 不做 realpath 规范化,字符串不一致会触发一次约 5s 的模型卸载+重载
# Qwen3.6-... 是符号链接,真实目录是 Qwen3___6-... 但 mlx-vlm 不在乎,只看字符串
